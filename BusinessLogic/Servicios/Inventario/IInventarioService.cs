...
namespace BusinessLogic.Servicios.Inventario
{
    public interface IInventarioService
    {
        ...
        Task<IReadOnlyList<ActivoInventarioDetailDto>> ObtenerActivosPorUsuarioAsync(string usuarioActualId);
        ...
        Task<byte[]> ExportarInventarioExcelAsync(string? q, int? idTipoActivo, int? idEstadoActivo);
